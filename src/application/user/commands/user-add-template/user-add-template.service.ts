...
import { type UserRepository, TaskTemplate } from '@/domain/user'
import { type UserAddTemplateCommand } from './user-add-template.command'

export class UserAddTemplateService implements ICommandHandler<UserAddTemplateCommand, void> {
  constructor(private readonly userRepository: UserRepository) {}
  async execute(command: UserAddTemplateCommand): Promise<void> {
